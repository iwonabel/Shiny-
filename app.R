...
ui <- fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            p("This is an applcation exploring the correlation analysis. Upload some data and inspect your correlation. Your file must be in csv format to upload."),
            fileInput(inputId = "datafile", label = "Upload data file", multiple = FALSE, placeholder = "No file selected", accept = "csv"),
            ...
            checkboxInput(inputId = "residuals", label = "Show residuals", value = FALSE),
